...
User Function JOBBX002()
	...
	If Select("SX6") == 0
		...
		FWLogMsg("INFO", /*cTransactionId*/, "BOMIX", /*cCategory*/, /*cStep*/, /*cMsgId*/, OemToAnsi("JOB - Sistema de SIGMA - IMPORTAวรO"), /*nMensure*/, /*nElapseTime*/, /*aMessage*/)
	...
	If Select("SX6") == 0
		FWLogMsg("INFO", /*cTransactionId*/, "BOMIX", /*cCategory*/, /*cStep*/, /*cMsgId*/, OemToAnsi("Job Sistema de SIGMA/IMPORTAวรO executado!") , /*nMensure*/, /*nElapseTime*/, /*aMessage*/)
		RESET ENVIRONMENT
	Endif
...
Static Function f_JobImporta()
	...
	cBmLog := OemToAnsi("Executando - JOB - Sistema de SIGMA - IMPORTAวรO")
	...
	If !Empty(c_Dir)
		...
		WHILE !(TRC->(EOF()))
			...
			IF FWRITE(c_Destino,c_Linha,LEN(c_Linha)) != LEN(c_Linha)
				...
				If Select("SX6") == 0
					cBmLog := "Ocorreu um erro na grava็ใo do arquivo destino. Continuar?"
					FWLogMsg("INFO", /*cTransactionId*/, "BOMIX", /*cCategory*/, /*cStep*/, /*cMsgId*/, cBmLog, /*nMensure*/, /*nElapseTime*/, /*aMessage*/)
					FCLOSE(c_Destino)
					DBSELECTAREA("TRC")
					DBGOTOP()
