...
User Function JOBBX001
	...
	If Select("SX6") == 0
		...
		FWLogMsg("INFO", /*cTransactionId*/, "BOMIX", /*cCategory*/, /*cStep*/, /*cMsgId*/, OemToAnsi("JOB - Sistema de SIGMA - PROGRAMAวรO"), /*nMensure*/, /*nElapseTime*/, /*aMessage*/)
	...
	If len(aParadasProg) > 0
		...
		if l_conectou
			...
			Else
				If Select("SX6") == 0
					FWLogMsg("INFO", /*cTransactionId*/, "BOMIX", /*cCategory*/, /*cStep*/, /*cMsgId*/, "Inicio  : "+Time(), /*nMensure*/, /*nElapseTime*/, /*aMessage*/)
					FWLogMsg("INFO", /*cTransactionId*/, "BOMIX", /*cCategory*/, /*cStep*/, /*cMsgId*/, OemToAnsi("E-mail enviado com sucesso-Sistema de SIGMA - PROGAMAวรO"), /*nMensure*/, /*nElapseTime*/, /*aMessage*/)
				Else
	...
	If Select("SX6") == 0
		FWLogMsg("INFO", /*cTransactionId*/, "BOMIX", /*cCategory*/, /*cStep*/, /*cMsgId*/, OemToAnsi("Job Sistema de SIGMA/PARADAS executado!"), /*nMensure*/, /*nElapseTime*/, /*aMessage*/)
		RESET ENVIRONMENT
	Else
